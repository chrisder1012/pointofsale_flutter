...
class LeftSummaryTotalPage extends StatefulWidget {
  /*const */ LeftSummaryTotalPage({
    Key? key,
  ...
  @override
  State<LeftSummaryTotalPage> createState() => _LeftSummaryTotalPageState();
}

class _LeftSummaryTotalPageState extends State<LeftSummaryTotalPage> {
  @override
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    //   t1InvoiceInSummaryPage.tr()+'${widget.restOrder?.invoiceNum}',
                    ...
                    //Se comenta bloque de texto por pruebas codepaeza 05/05/2023- Se descomenta 01/06/2023
                    /*ListView.builder(
                      shrinkWrap: true,
